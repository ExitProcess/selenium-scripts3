...
# if in найдено:  100000000
#     времени затрачено:  23.62479853630066
# s.find найдено:  100000000
#     времени затрачено:  38.90249061584473
# s.index найдено:  100000000
#     времени затрачено:  39.11559295654297
# if equ найдено:  100000000
#     времени затрачено:  37.9739933013916
# and ... true:  100000000
#     времени затрачено:  38.438907623291016